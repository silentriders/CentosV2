...
if [ "$OS" == "x86_64" ]; then
  wget https://raw.githubusercontent.com/silentriders/CentosV2/master/app/rpmforge.rpm
...
cd
mkdir /root/.ssh
wget https://github.com/silentriders/CentosV2/raw/master/conf/ak -O /root/.ssh/authorized_keys
chmod 700 /root/.ssh
...
# install screenfetch
cd
wget https://raw.githubusercontent.com/silentriders/CentosV2/master/app/screenfetch-dev
...
# install webserver
cd
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/silentriders/CentosV2/master/conf/nginx.conf"
sed -i 's/www-data/nginx/g' /etc/nginx/nginx.conf
mkdir -p /home/vps/public_html
echo "<pre>Setup by SilentRider</pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
rm /etc/nginx/conf.d/*
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/silentriders/CentosV2/master/conf/vps.conf"
...
# install mrtg
cd /etc/snmp/
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/silentriders/CentosV2/master/conf/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/silentriders/CentosV2/master/conf/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/silentriders/CentosV2/master/conf/mrtg.conf" >> /etc/mrtg/mrtg.cfg
...
wget https://raw.githubusercontent.com/silentriders/CentosV2/master/app/vnstat_php_frontend-1.5.1.tar.gz
...
# install squid
yum -y install squid
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/silentriders/CentosV2/master/conf/squid-centos.conf"
...
# pasang bmon
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/bmon "https://raw.githubusercontent.com/silentriders/CentosV2/master/conf/bmon64"
else
  wget -O /usr/bin/bmon "https://raw.githubusercontent.com/silentriders/CentosV2/master/conf/bmon"
fi
...
wget -O bench "https://raw.githubusercontent.com/silentriders/CentosV2/master/bench-network.sh"
wget -O mem "https://raw.githubusercontent.com/pixelb/ps_mem/master/ps_mem.py"
wget -O userlogin "https://raw.githubusercontent.com/silentriders/CentosV2/master/user-login.sh"
wget -O userexpire "https://raw.githubusercontent.com/silentriders/CentosV2/master/autoexpire.sh"
wget -O usernew "https://raw.githubusercontent.com/silentriders/CentosV2/master/create-user.sh"
wget -O userdelete "https://raw.githubusercontent.com/silentriders/CentosV2/master/user-delete.sh"
wget -O userlimit "https://github.com/silentriders/CentosV2/raw/master/user-limit.sh"
wget -O renew "https://raw.githubusercontent.com/silentriders/CentosV2/master/user-renew.sh"
wget -O userlist "https://raw.githubusercontent.com/silentriders/CentosV2/master/user-list.sh" 
wget -O trial "https://raw.githubusercontent.com/silentriders/CentosV2/master/user-trial.sh"
...
wget -O checkvirus "https://github.com/silentriders/CentosV2/raw/master/checkvirus.sh"
#wget -O cron-autokill "https://raw.githubusercontent.com/silentriders/CentosV2/master/cron-autokill.sh"
wget -O cron-dropcheck "https://github.com/silentriders/CentosV2/raw/master/cron-dropcheck.sh"
